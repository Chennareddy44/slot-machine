...
const numberOfLinesIsValid = (numberOfLines, balance) => {
  if (numberOfLines > balance) {
    throw new Error("Invalid number of lines: Not enough balance.Try again.");
  }
};
...
const game = () => {
  ...
  while (balance > 0) {
    ...
    try {
      numberOfLinesIsValid(numberOfLines, balance);
    } catch (error) {
